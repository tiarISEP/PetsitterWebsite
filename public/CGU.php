...
$cgu_versions = $pdo->query(
    "SELECT * FROM cgu_versions WHERE is_active = 1 ORDER BY version_number"
)->fetchAll();
    ...
    <div class="faq-page-container">
        ...
        <?php else: ?>
            ...
            <div class="faq-category">
                ...
                <div class="cgu-meta" style="font-size: 0.85rem; color: #666; margin-top: 1rem;">
        ...
        <div class="cgu-footer" style="margin-top: 3rem; padding-top: 2rem; border-top: 1px solid #ddd; color: #666; font-size: 0.9rem;">
            <p>Last updated: <?php echo date('F d, Y', strtotime($cgu_versions[0]['created_at'] ?? 'now')); ?></p>
            <p>If you have any questions about these terms, please <a href="ContactUs.php">contact us</a>.</p>
        </div>
    </div>
</main>
