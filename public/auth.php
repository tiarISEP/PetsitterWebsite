...
function getUserById($pdo, $user_id) {
    ...
    $stmt = $pdo->prepare("SELECT id, username, first_name, last_name, email, phone, bio, avatar_url, user_type, is_admin, is_sitter, is_owner, is_super_admin, is_banned, created_at FROM users WHERE id = ?");
